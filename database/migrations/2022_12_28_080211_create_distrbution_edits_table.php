...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('distrbution_edits', function (Blueprint $table) {
            $table->id();
            $table->string("IDorderDetail");
            $table->string("Depot"); //ดีโป้
            $table->string("ShipDate"); //วันที่ส่ง
            $table->string("Day_ShipDate")->nullable();
            $table->string("Queue")->nullable();
            $table->string("Employee")->nullable(); // ชื่อคนส่ง
    ...
    {
        Schema::dropIfExists('distrbution_edits');
    }
};
